...
public class Crane extends Structure {
        public static final Codec<Crane> CODEC = RecordCodecBuilder.<Crane>mapCodec(instance ->
                instance.group(Crane.settingsCodec(instance),
                ...
                ).apply(instance, Crane::new)).codec();
        ...
        public Crane(StructureSettings config,
        ...
        public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
            ...
            if (!Crane.extraSpawningChecks(context)) {
        ...
        @Override
        public StructureType<Crane> type() {
            return Structures.PBCrane.get();
        }
