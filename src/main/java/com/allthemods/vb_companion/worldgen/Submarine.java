...
public class Submarine extends Structure {
        public static final Codec<Submarine> CODEC = RecordCodecBuilder.<Submarine>mapCodec(instance ->
                instance.group(Submarine.settingsCodec(instance),
                ...
                ).apply(instance, Submarine::new)).codec();
        ...
        public Submarine(StructureSettings config,
        ...
        public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
            ...
            if (!Submarine.extraSpawningChecks(context)) {
        ...
        @Override
        public StructureType<Submarine> type() {
            return Structures.PBSubmarine.get();
        }
