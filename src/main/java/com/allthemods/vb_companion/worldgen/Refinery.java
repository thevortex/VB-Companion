...
public class Refinery extends Structure {
        public static final Codec<Refinery> CODEC = RecordCodecBuilder.<Refinery>mapCodec(instance ->
                instance.group(Refinery.settingsCodec(instance),
                ...
                ).apply(instance, Refinery::new)).codec();
        ...
        public Refinery(StructureSettings config,
        ...
        public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
            ...
            if (!Refinery.extraSpawningChecks(context)) {
        ...
        @Override
        public StructureType<Refinery> type() {
            return Structures.PBRefinery.get();
        }
