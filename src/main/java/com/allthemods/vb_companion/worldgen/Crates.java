...
public class Crates extends Structure {
        public static final Codec<Crates> CODEC = RecordCodecBuilder.<Crates>mapCodec(instance ->
                instance.group(Crates.settingsCodec(instance),
                ...
                ).apply(instance, Crates::new)).codec();
        ...
        public Crates(StructureSettings config,
        ...
        public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
            ...
            if (!Crates.extraSpawningChecks(context)) {
        ...
        @Override
        public StructureType<Crates> type() {
            return Structures.PBCrates.get();
        }
