...
public class Train extends Structure {
        public static final Codec<Train> CODEC = RecordCodecBuilder.<Train>mapCodec(instance ->
                instance.group(Train.settingsCodec(instance),
                ...
                ).apply(instance, Train::new)).codec();
        ...
        public Train(StructureSettings config,
        ...
        public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
            ...
            if (!Train.extraSpawningChecks(context)) {
        ...
        @Override
        public StructureType<Train> type() {
            return Structures.PBTrain.get();
        }
