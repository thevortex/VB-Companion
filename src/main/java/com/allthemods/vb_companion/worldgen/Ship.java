...
public class Ship extends Structure {
        public static final Codec<Ship> CODEC = RecordCodecBuilder.<Ship>mapCodec(instance ->
                instance.group(Ship.settingsCodec(instance),
        ...
        public Ship(StructureSettings config,
        ...
        public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
            ...
            if (!Ship.extraSpawningChecks(context)) {
        ...
        @Override
        public StructureType<Ship> type() {
            return Structures.PBShip.get();
        }
