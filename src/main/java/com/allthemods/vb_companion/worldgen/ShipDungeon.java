...
public class ShipDungeon extends Structure {
        public static final Codec<ShipDungeon> CODEC = RecordCodecBuilder.<ShipDungeon>mapCodec(instance ->
                instance.group(ShipDungeon.settingsCodec(instance),
                ...
                ).apply(instance, ShipDungeon::new)).codec();
        ...
        public ShipDungeon(Structure.StructureSettings config,
        ...
        public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
            ...
            if (!ShipDungeon.extraSpawningChecks(context)) {
        ...
        @Override
        public StructureType<ShipDungeon> type() {
            return Structures.ShipsDungeon.get();
        }
